                        ...
                        <header>
                          ...
                          <div class="row">
                            <div class="form-group col-md-6">
                              ...
                              {!! Form::text('name',null,['class'=>$errors->has('name') ? 'form-control is-invalid ' :'form-control','placeholder'=>'name harus di isi','required']) !!}
                            ...
                            <div class="form-group col-md-12">
                              ...
                              {!! Form::textarea('body',null,['id'=>'usercomment','class'=>$errors->has('body') ? 'form-control is-invalid ' :'form-control','placeholder'=>'Type your comment','required']) !!}
