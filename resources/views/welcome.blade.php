...
@section('content')
    ...
    <section style="background: url({{ asset('assets/blog/img/hero.jpg') }}); background-size: cover; background-position: center center" class="hero">
        <div class="container">
          <div class="row">
            <div class="col-lg-7">
              <h1>Blog - Make a blog</h1><a href="#" class="hero-link">Discover More</a>
            </div>
      ...
      <section class="featured-posts no-padding-top">
        <div class="container">
          <!-- Post-->
            <?php $i=0;foreach($posts->orderBy('published_at','DESC')->limit(3)->get() as $post) : $i++?>
                @if($i % 2!=0)
                <div class="row d-flex align-items-stretch">
                    <div class="text col-lg-7">
                        ...
                        <div class="content">
                            ...
                            <div class="category"><a href="{{url('/blog/'.$post->slug)}}">{{ $post->category->title }}</a></div>
